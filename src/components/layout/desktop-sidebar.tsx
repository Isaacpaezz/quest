...
import { BookOpen, Users, History, Newspaper, User, ListChecks, ShieldX, Settings, Trophy, Award, DollarSign, UsersRound } from 'lucide-react'
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 border-r fixed h-full bg-background">
      ...
      <nav className="flex-1 p-4 space-y-2">
        ...
        <Link href="/home" className="flex items-center gap-3 px-2 py-2 rounded-md text-sm font-medium hover:bg-muted">
          <BookOpen className="h-5 w-5" /> Sustento
        </Link>
        <Link href="/community" className="flex items-center gap-3 px-2 py-2 rounded-md text-sm font-medium hover:bg-muted">
          <Users className="h-5 w-5" /> Comunidad
        </Link>
        <Link href="/grupos" className="flex items-center gap-3 px-2 py-2 rounded-md text-sm font-medium hover:bg-muted">
          <UsersRound className="h-5 w-5" /> Grupos
        </Link>
        <Link href="/history" className="flex items-center gap-3 px-2 py-2 rounded-md text-sm font-medium hover:bg-muted">
        ...
        <h2 className="px-2 pt-4 text-xs font-semibold tracking-wider text-muted-foreground uppercase">Gamificación</h2>
        <Link href="/challenges" className="flex items-center gap-3 px-2 py-2 rounded-md text-sm font-medium hover:bg-muted">
          <Trophy className="h-5 w-5" /> Retos
        </Link>
        <Link href="/badges" className="flex items-center gap-3 px-2 py-2 rounded-md text-sm font-medium hover:bg-muted">
          <Award className="h-5 w-5" /> Badges
        </Link>
        <Link href="/debts" className="flex items-center gap-3 px-2 py-2 rounded-md text-sm font-medium hover:bg-muted">
          <DollarSign className="h-5 w-5" /> Deudas
        </Link>
